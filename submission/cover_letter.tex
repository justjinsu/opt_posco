...
Please find enclosed the manuscript titled ``Testing the limits of carbon pricing: Can Korea's emissions trading system align steel industry investments with national climate targets?'' for consideration in \emph{Energy Policy}. The paper provides the first optimisation-based assessment of Korea's K-ETS price trajectory against a firm-level carbon budget, demonstrating that current policy settings still overshoot POSCO's allocation by 7\% even under the NGFS Net Zero pathway.
