...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.85\textwidth]{figures/fig_tech_shares.pdf}
...
\label{fig:tech-shares}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.85\textwidth]{figures/fig_emissions.pdf}
...
\begin{tabular}{lrrr}
\toprule
\textbf{Cost Component} & \textbf{Net Zero 2050} & \textbf{Below 2°C} & \textbf{NDCs} \\
\midrule
\textbf{Capital expenditure} & & & \\
~~H$_2$-DRI plants & 36.0 & 0.0 & 0.0 \\
~~EAF capacity & 8.2 & 1.2 & 1.2 \\
~~Blast furnace relining & 12.4 & 28.5 & 28.8 \\
~~\textit{Subtotal CAPEX} & \textit{56.6} & \textit{29.7} & \textit{30.0} \\
\midrule
\textbf{Operating expenditure} & & & \\
...
~~\textit{Subtotal OPEX} & \textit{436.5} & \textit{485.8} & \textit{487.2} \\
\midrule
\textbf{ETS compliance costs} & 43.0 & 57.8 & 59.7 \\
\midrule
\textbf{Total system cost} & \textbf{536.1} & \textbf{573.3} & \textbf{576.9} \\
\midrule
\textit{Average cost (\$/t steel)} & \textit{815} & \textit{847} & \textit{861} \\
\textit{CAPEX share (\%)} & \textit{42\%} & \textit{32\%} & \textit{35\%} \\
\textit{ETS cost share (\%)} & \textit{5\%} & \textit{6\%} & \textit{7\%} \\
\bottomrule
\end{tabular}
\end{table}
